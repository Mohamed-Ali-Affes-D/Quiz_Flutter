...
class _QuizPageState extends State<QuizPage> {
  ...
  void _saveScore(int correctAnswers) async {
    ...
    String key =
        "${widget.selectedType ?? 'Default'}-${'Easy'}"; // You can use real difficulty
  ...
  void _showResult() {
    ...
    if (scorePercentage < 50) {
      ...
      feedbackIcon = Icon(Icons.thumb_up, size: 80, color: Colors.orangeAccent);
      ...
      feedbackIcon = Icon(Icons.emoji_events, size: 80, color: Colors.green);
    }
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => LeaderboardPage(
                              selectedCategory:
                                  widget.selectedType ?? 'Default',
                              selectedDifficulty:
                                  'Easy', // Adjust based on your logic
                            ),
                          ),
                        );
                      },
...
class QuestionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color cardColor = brightness == Brightness.dark
        ? Colors.black
            .withOpacity(0.7) // Slightly transparent black for dark mode
        : Colors.white
            .withOpacity(0.7); // Slightly transparent white for light mode
      ...
      child: SizedBox(
        ...
        child: Wrap(
          ...
          Card(
            ...
            child: SingleChildScrollView(
              // Ajout d'un scroll pour éviter les débordements
              child: Padding(
